onload = function () {
    ...
    const cities = ['Delhi', 'Mumbai', 'London', 'Paris', 'New York', 'Ohio', 'Sydney', 'Doha', 'Dubai', 'Washington DC', 'Amsterdam', 'Cape Town', 'Auckland', 'Toronto', 'Kyiv', 'Moscow'];
    ...
    function createData() {
        ...
        if (src === V) src = Math.floor(Math.random() * V) + 1;
        dst = V;
        curr_data = {
            nodes: nodes,
            edges: edges
